...
/**
 * Item to be rendered inside of a FilterMenuListbox.
 */
const FilterMenuItem = /*#__PURE__*/React.forwardRef(function FilterMenuItem({
  children,
  className = '',
  classNames = {},
  id: idProp,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(menu_item.MenuItem, {
    ...
    railStart: selectedOptionId ? railStart : null,
