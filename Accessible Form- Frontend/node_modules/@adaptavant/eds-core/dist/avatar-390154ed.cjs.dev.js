...
var context = require('./context-f3c0b29b.cjs.dev.js');
...
const getAvatarStyles = ({
  ...
  statusBadge: tw.tw`
		...
		${isGuest ? tw.tw`rounded-6px` : tw.tw`rounded-full`}
		absolute
...
const initialSizeMap = {
  '16': tw.tw`text-body-8`,
  '20': tw.tw`text-body-10`,
  '24': tw.tw`text-body-10`,
  '32': tw.tw`text-body-12`,
  '40': tw.tw`text-body-14`,
  '48': tw.tw`text-body-14`,
  '64': tw.tw`text-body-20`,
  '96': tw.tw`text-heading-28 font-stronger`
};
...
const statusBadgeColorMap = {
  available: tw.tw`fill-status-available`,
  away: tw.tw`fill-status-away`,
  busy: tw.tw`fill-status-busy`,
  offline: tw.tw`fill-status-offline`,
  onCall: tw.tw`fill-decoration-brand`,
  audioCall: tw.tw`fill-decoration-brand`,
  customer: tw.tw`fill-decoration-brand`
};
const avatarSizeMap = {
  '16': tw.tw`
		h-4
...
const Avatar = /*#__PURE__*/React.forwardRef(function Avatar({
  ...
  function AvatarChildren() {
    ...
    return children ?? /*#__PURE__*/jsxRuntime.jsx(text.Text, {
      "aria-hidden": true,
      ...styleProps('initial'),
      children: name.charAt(0)
    });
  }
  return /*#__PURE__*/jsxRuntime.jsx(context.AvatarContextProvider, {
    value: {
      size,
      styleProps
    },
    children: /*#__PURE__*/jsxRuntime.jsxs(box.Box, {
      ...
      role: "text",
      ...styleProps('root'),
      children: [/*#__PURE__*/jsxRuntime.jsx(AvatarChildren, {}), /*#__PURE__*/jsxRuntime.jsx(AvatarStatusBadge, {
        status: status
      })]
    })
  });
...
function AvatarImage({
  ...
  if (hasImageError) {
    return /*#__PURE__*/jsxRuntime.jsx(brokenImageIcon.BrokenImageIcon, {
