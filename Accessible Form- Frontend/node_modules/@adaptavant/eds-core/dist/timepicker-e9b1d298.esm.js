...
import { T as TimePickerInputState } from './types-5a66701d.esm.js';
import { t as tw } from './tw-c6a9a210.esm.js';
import { TimePickerInput } from './timepicker-input-16dd9ba9.esm.js';
import { TimePickerItem } from './timepicker-item-324467f0.esm.js';
import { TimePickerListbox } from './timepicker-listbox-021b96a1.esm.js';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { B as Box } from './box-a5dda214.esm.js';
import { Combobox } from './combobox-76c21909.esm.js';
import { ComboboxPopover } from './combobox-popover-abd204b9.esm.js';
import { InlineField } from './inline-field-9132b9f6.esm.js';
import { Field } from './field-d7a4c6ed.esm.js';
...
const addCustomTimeOptions = ({
  ...
  !times.some(timeOption => timeOption.time === format(date, timeFormat)))
...
const validateTimeFormat = (input, helperFormat) => {
  ...
  const parsedDate = parse(correctedInput, helperFormat, new Date());
  const formattedTime = format(parsedDate, helperFormat);
  return {
...
const getTimeOption = (date, helperFormat) => {
  ...
  const formattedTime = format(updatedDate, helperFormat);
...
const getTimePickerInputState = (date, minValue, maxValue) => {
  if (!date) {
    return TimePickerInputState.EMPTY;
  }
  if (minValue && date <= minValue) {
    return TimePickerInputState.LTE_MIN;
  } else if (maxValue && date >= maxValue) {
    return TimePickerInputState.GTE_MAX;
  } else {
    return TimePickerInputState.VALID;
  }
};
...
const commonLabelStyles = tw`tabular-nums whitespace-nowrap`;
...
const TimePicker = /*#__PURE__*/forwardRef(function TimePicker({
  className,
  classNames = {},
  clear = false,
  customValues,
  ...
  const handleInputChange = () => {
    ...
    const handleInvalidInput = () => {
      ...
      onSelect({
        newOption: undefined,
        inputState: TimePickerInputState.INVALID_FORMAT
      });
    };
  ...
  const FieldComponent = variant === 'subtle' ? InlineField : Field;
  return /*#__PURE__*/jsx(FieldComponent, {
    ...
    children: /*#__PURE__*/jsxs(Combobox, {
      ...
      children: [/*#__PURE__*/jsx(TimePickerInput, {
        ...
        ref: forwardedRef,
        ...parts.input
      }), /*#__PURE__*/jsxs(ComboboxPopover, {
        shouldUsePortal: shouldUsePortal,
        ...parts.popover,
        children: [(dayOptions === null || dayOptions === void 0 ? void 0 : dayOptions.length) > 0 ? /*#__PURE__*/jsxs(Fragment, {
          children: [/*#__PURE__*/jsx(RenderTimePickerItems, {
        ...
        }) : null, /*#__PURE__*/jsx(TimePickerListbox, {
...
const RenderTimePickerItems = ({
  ...
  return /*#__PURE__*/jsx(Fragment, {
    children: timeOptions.map(option => /*#__PURE__*/jsx(TimePickerItem, {
      id: option.time,
      option: option,
      ...
      children: /*#__PURE__*/jsxs(Box, {
        ...
        }), option.durationLabel ? /*#__PURE__*/jsx(Box, {
          as: "span",
          ...parts.durationLabel,
