 ...
 */
const TimePickerItem = forwardRefWithGenericComponent(function TimePickerItem({
  children,
  className = '',
  classNames = {},
  id: idProp,
  ...
  const railStart = isSelectedFromOptions ? /*#__PURE__*/jsx(AlignChildToText, {
  ...
  const styleProps = getStyleProps({
    ...
    style,
    styles,
    tw: getComboboxItemStyles(isSelectedFromOptions)
  });
