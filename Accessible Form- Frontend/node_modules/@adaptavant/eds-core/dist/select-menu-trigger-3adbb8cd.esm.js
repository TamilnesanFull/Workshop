...
import { forwardRef, useId, useCallback, Fragment, useState, useEffect } from 'react';
...
import { useSelectMenuContext } from './context-4a044c72.esm.js';
import { b as getSelectMenuTriggerStyles } from './styles-3dd5cb2b.esm.js';
...
const SelectMenuTrigger = /*#__PURE__*/forwardRef(function SelectMenuTrigger({
  children,
  className = '',
  classNames = {},
  iconEnd,
  ...
  const {
    triggerProps
  } = useSelectMenuTriggerProps(context);
...
export { SelectMenuTrigger, useSelectMenuTriggerProps };
