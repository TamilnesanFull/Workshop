...
import { useFilteredOptions } from './use-filtered-options-d881803c.esm.js';
...
function TimeZonePickerItemLabel({
  ...
  const railEnd = shouldWrap && time && meridiem ? /*#__PURE__*/jsxs("div", {
...
function highlightMatchedContent(text, searchTerm) {
  ...
  return parts.map((part, index) => regex.test(part) ? /*#__PURE__*/jsx(Box, {
    as: "span",
...
function useTimeZonePicker({
  ...
  const localeTZ = useMemo(() => preferredTzIdentifier ? undefined : Vr(), [preferredTzIdentifier]);
  ...
  return {
     ...
     */
    getFilterMenuProps: useCallback(() => {
      return {
        popoverMaxWidth: 320
      };
    }, []),
     ...
     */
    getFilterMenuTriggerProps: useCallback(() => {
      return {
        children: /*#__PURE__*/jsx(TimeZonePickerItemLabel, {
          ...selectedOption
        })
      };
    }, [selectedOption]),
     ...
     */
    getFilterMenuSearchFieldProps: useCallback(() => {
      return {
     ...
     */
    getFilterMenuSearchInputProps: useCallback(() => {
      return {
        placeholder: 'Search...',
        ...getSearchInputProps()
      };
     ...
     */
    getFilterMenuListboxProps: useCallback(() => {
      return {
        noResultsFallback: /*#__PURE__*/jsx(Text, {
     ...
     * FilterMenuItem.
     */
    getFilterMenuItemProps: useCallback(option => {
