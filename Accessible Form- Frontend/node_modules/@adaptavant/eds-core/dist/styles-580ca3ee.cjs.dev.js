...
const getCheckboxStyles = ({
  ...
  root: tw.tw`
	`,
  checkboxPrimitiveRoot: tw.tw`
	`,
  checkboxPrimitiveInput: tw.tw`
	`,
  checkboxPrimitiveControl: tw.tw`
	`,
  checkboxPrimitiveIcon: tw.tw`
	`,
  label: tw.tw`
...
const getCheckboxPrimitiveStyles = ({
  isInvalid,
  size
}) => ({
  root: tw.tw`
...
`;
const indeterminateStyles = tw.tw`
...
exports.getCheckboxPrimitiveStyles = getCheckboxPrimitiveStyles;
