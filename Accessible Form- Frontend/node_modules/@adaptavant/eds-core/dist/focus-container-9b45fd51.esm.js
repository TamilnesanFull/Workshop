...
import { FocusRefContextProvider } from './context-a53e025d.esm.js';
...
const FocusContainer = forwardRefWithGenericComponent(function FocusContainer({
  adornmentEnd,
  adornmentStart,
  children,
  className = '',
  ...
  const ref = useRef();
  return /*#__PURE__*/jsx(FocusRefContextProvider, {
    value: ref,
    children: /*#__PURE__*/jsxs(Track, {
      ...consumerProps,
      railEnd: adornmentEnd ? /*#__PURE__*/jsx(Box, {
        as: "span",
        ...styleProps('adornmentEnd'),
        children: adornmentEnd
      }) : null,
      railStart: adornmentStart ? /*#__PURE__*/jsx(Box, {
        as: "span",
...
function useCombinedFocusContainerInputStyles({
  ...
  return getStyleProps({
    className: cx(getFocusContainerTwStyles({
      isDisabled,
      isGhost,
      isInvalid
    }).control, className),
...
export { FocusContainer, useCombinedFocusContainerInputStyles };
