...
import { a as parseErrorTranslations, p as parseImageProcessingOptions, D as DEFAULT_IMAGE_PROCESSING_OPTIONS } from './parse-image-processing-options-6f68c68d.esm.js';
...
const compressImage = (blob, options) => new Promise((resolve, reject) => {
  Reflect.construct(Compressor, [blob, {
...
const processLocalFile = async (file, translations, imageProcessingOptions = DEFAULT_IMAGE_PROCESSING_OPTIONS, onError) => {
  const parsedErrorTranslations = parseErrorTranslations(translations);
  const parsedImageProcessingOptions = parseImageProcessingOptions(imageProcessingOptions);
  try {
...
export { createImageElement as a, createUrl as b, compressImage as c, resizeImage as d, handleTryCatchError as h, isFileSizeValid as i, processLocalFile as p, readFileImage as r, validateImageType as v };
