...
function basePlugin({
  ...
  return plugin__default["default"](({
    addBase
  }) => {
 ...
 */
const componentsPlugin = plugin__default["default"](({
  addComponents,
  theme
}) => {
 ...
 */
const highContrastPlugin = plugin__default["default"](({
  addVariant
}) => {
 ...
 */
const utilitiesPlugin = plugin__default["default"](({
  addUtilities
}) => {
  addUtilities({
 ...
 */
const wherePlugin = plugin__default["default"](({
  addVariant
}) => {
...
function getBorderRadiusThemeConfig(tokens, {
  ...
  return {
    borderRadius: {
      ...(shouldUseTailwindBorderRadius ? defaultTheme__default["default"].borderRadius : undefined),
...
exports.commonBlocklist = commonBlocklist;
exports.commonSafelist = commonSafelist;
exports.createPreset = createPreset;
exports.cropModalSafelist = cropModalSafelist;
